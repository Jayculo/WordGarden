...
//  WordGarden
//
//  Created by OROZCO, NOAH on 1/13/26.
//
...
struct ContentView: View {
  private static let maximumGuesses = 8 // Need to refer to this as Self.maximumGuesses
    ...
    @State private var currentWordIndex = 0 // indez in wordsToGuess
    @State private var wordToGuess = ""
    @State private var revealedWord = ""
    @State private var lettersGuessed = ""
    @State private var guessedRemanining = 8
    @State private var guessedLetter = ""
    @State private var imageName = "flower8"
    @State private var playAgainHidden = true
    @State private var playAgainButtonLabel = "AnotherWord?"
    @State private var audioPlayer: AVAudioPlayer!
    @FocusState private var textFieldIsFocused: Bool
    private let wordsToGuess = ["SWIFT", "DOG", "Cat"] // AllCaps
    var body: some View {
        VStack {
            HStack {
            ...
            if playAgainHidden {
                ...
                Button(playAgainButtonLabel) {
                    ...
                    lettersGuessed = ""
                    guessedRemanining = Self.maximumGuesses
                    imageName = "flower\(guessedRemanining)"
    ...
    func updateGamePlay() {
        if !wordToGuess.contains(guessedLetter) {
            guessedRemanining -= 1
            imageName = "wilt\(guessedRemanining)"
        ...
        } else if guessedRemanining == 0 { // Word missed
            gameStatusMessage = "So Sorry, You're All Out of"
            wordsMissed += 1
            currentWordIndex += 1
            playAgainHidden = false
